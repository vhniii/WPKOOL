...
if ( survey.style != 'flat' ) {
  ...
  ( function() {        
	...
	jQuery("#survey .survey_question, #survey .survey_answers").css("background",jQuery.trim(bgs[i]));
	}
	jQuery("#survey .survey_question, #survey .survey_answers").css("color",survey_options[4]);
	jQuery("#survey .survey_question, #survey .survey_answers").css("border","solid "+survey_options[6]+"px "+survey_options[5]);
	jQuery("#survey .survey_question, #survey .survey_answers").css("padding",survey_options[9]+"px");
	jQuery("#survey .survey_question, #survey .survey_answers").css("font-size",survey_options[8]+"px");
	jQuery("#survey .survey_question, #survey .survey_answers").css("border-radius",survey_options[7]+"px");
