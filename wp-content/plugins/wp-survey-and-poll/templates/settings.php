	...
	<input type="text" id="survey_name" value="" size="50" placeholder="Type the survey name here" /><a id="add_new_survey" class="button button-primary">New Survey</a><span id="error_log"></span>
	<div style="display:none;" id="new_survey_content">
	  ...
	  <div>
			...
			<div class="wp_sap_checkbox"><label class="text wp_sap_tooltip" style="width: 200px;" title="Enable if you want to display the survey on the entire website"><input type="checkbox" name="global_survey" class="inputtext global_survey" value="0" /> Global Survey</label></div>
			...
			<div style="clear:both;"></div>
			<div class="form-area"><a class="add_question button button-primary">Add New Question</a></div>
			<div style="clear:both;"></div>
		...
		<div id="question_1">
			...
			<span>
			<p>1. answer: <input type="text" name="answer[]" class="answer" id="answer1" value="Yes" placeholder="yes" /><span id="answer_count1" class="answer_count">0 - 0%</span></p>
			<p>2. answer: <input type="text" name="answer[]" class="answer" id="answer2" value="No" placeholder="no" /><span id="answer_count2" class="answer_count">0 - 0%</span><a class="add_answer"><img class="wp_sap_tooltip" title="Add New Answer" src="<?php print(plugins_url( '/assets/img/add.svg' , __FILE__ ));?>"></a></p>
			</span>
		</div>
		</div>
	  ...
	  <div id="'.$sv->id.'"><div class="shortcode_section"><div class="inner-block">Modal Shortcode: <input type="text" readonly="true" class="copytext" value="[wpsurveypoll id=&quot;'.$sv->id.'&quot;]"></div><div class="inner-block">Embed Shortcode: <input type="text" readonly="true" class="copytext" value="[wpsurveypoll id=&quot;'.$sv->id.'&quot; style=&quot;flat&quot;]"></div><div class="inner-block" style="display: none;">Results: <input type="text" readonly="true" class="copytext" value="[wpsurveypoll_results id=&quot;'.$sv->id.'&quot;]"></div></div>
			...
			<div class="play_button"><img class="wp_sap_tooltip" title="Play Survey" src="'.plugins_url( '/assets/img/play-button.png' , __FILE__ ).'"></div>
