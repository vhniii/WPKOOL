    ...
    if (!class_exists('DOPBSPTranslationTextSettings')){
        class DOPBSPTranslationTextSettings{
            ...
            function settings($text){
                ...
                array_push($text, array('key' => 'SETTINGS_GENERAL_REFFERAL_ID',
                                        'parent' => 'PARENT_SETTINGS',
                                        'text' => 'Refferal ID'));
                
                array_push($text, array('key' => 'SETTINGS_GENERAL_REFFERAL_DISPLAY',
                                        'parent' => 'PARENT_SETTINGS',
                                        'text' => 'Refferal display'));
            ...
            function settingsHelp($text){
                ...
                array_push($text, array('key' => 'SETTINGS_GENERAL_REFFERAL_ID_HELP',
                                        'parent' => 'PARENT_SETTINGS_HELP',
                                        'text' => 'Enter your refferal ID.'));
                
                array_push($text, array('key' => 'SETTINGS_GENERAL_REFFERAL_DISPLAY_HELP',
                                        'parent' => 'PARENT_SETTINGS_HELP',
                                        'text' => 'Enable if you want to display a link with the refferal code in front-end.'));
