...
class Bookings_Controller extends REST_Controller
{
    ...
    public function get_stats( $request )
    {
        ...
        $datePeriod = new \DatePeriod(
            ...
            new \DateTime($request->get_param('end_date'))
        );
    ...
    public function create_item( $request )
    {
        ...
        try {
            ...
            $customer_data  = $this->get_customer_data_by_id($request->get_param('customer_id'));
            ...
            $id = $this->create_item_post($cloned_request);
        } catch (\Exception $ex) {
            return new WP_Error( 'salon_rest_cannot_create', $ex->getMessage(), array( 'status' => 404 ) );
        }
    ...
    public function update_item( $request )
    {
        ...
        try {
            ...
            if ($booking['customer_id'] != $request->get_param('customer_id')) {
                $customer_data  = $this->get_customer_data_by_id($request->get_param('customer_id'));
                $cloned_request->set_default_params(array_merge($cloned_request->get_default_params(), $customer_data));
            }

            $this->update_item_post($cloned_request, $request->get_param('id'));
        } catch (\Exception $ex) {
    ...
    protected function create_item_post($request)
    {
        ...
        return $bb->getLastBooking()->getId();
    }

    protected function update_item_post($request, $id)
    {
        $bb = new SLN_Wrapper_Booking_Builder(SLN_Plugin::getInstance());
        ...
        $id = wp_insert_post(array(
            ...
            'post_author' => $request->get_param('customer_id'),
            'meta_input'  => array(
