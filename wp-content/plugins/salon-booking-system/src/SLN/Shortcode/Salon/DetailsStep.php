...
class SLN_Shortcode_Salon_DetailsStep extends SLN_Shortcode_Salon_AbstractUserStep
{
    ...
    private function parseFBValues($params) {
    	return array(
		    'fb_id'     => isset($params['fb_id']) ? sanitize_text_field(wp_unslash($params['fb_id']))  : '',
		    'firstname' => isset($params['fb_firstname']) ? sanitize_text_field(wp_unslash($params['fb_firstname']))  : '',
		    'lastname'  => isset($params['fb_lastname']) ? sanitize_text_field(wp_unslash($params['fb_lastname']))  : '',
		    'email'     => isset($params['fb_email']) ? sanitize_text_field(wp_unslash($params['fb_email']))  : '',
		    'phone'     => '',
		    'address'   => '',
	    );
    }
