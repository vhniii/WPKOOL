...
class SLN_Action_Ajax_CheckServices extends SLN_Action_Ajax_Abstract
{
    ...
    public function execute()
    {
        ...
        if (isset($_POST['part'])) {
            ...
            if ($part == 'primaryServices') { // for frontend user
                ...
                $ret = $this->initAllServicesForAdmin($services,$_POST['_sln_booking'],false);
    ...
    protected function initAllServicesForAdmin($services,$bookingData, $with_booking_limit = true)
    {
        ...
        if(!$with_booking_limit) $count = isset($_POST['sln']['services']) && is_array($_POST['sln']['services']) ? count($_POST['sln']['services'])+1 : 0 ;
