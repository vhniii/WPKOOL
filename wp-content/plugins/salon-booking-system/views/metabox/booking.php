    ...
    <div class="row">
        ...
        if($additional_fields){
             foreach ($additional_fields as $field => $label) {
              $value = !$booking->getMeta($field) && isset(SLN_Enum_CheckoutFields::$additional_fields_defaults[$field])  ? SLN_Enum_CheckoutFields::$additional_fields_defaults[$field] : $booking->getMeta($field) ;
