                ...
                <tr>
                    <td align="left" valign="top"
                        ...
                        <?php if ($depositText) { ?>
                            ...
                            <span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; font-weight:normal;"><br/>Remaining <?php echo $plugin->format()->moneyFormatted($booking->getRemaingAmountAfterPay()) ?></span>
                        <?php } ?>
                    </td>
                </tr>
                <tr>
