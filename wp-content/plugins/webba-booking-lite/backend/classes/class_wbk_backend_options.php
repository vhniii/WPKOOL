...
class WBK_Backend_Options extends WBK_Backend_Component {
	...
	public function initSettings() {
		...
		register_setting(
			'wbk_options',
			'wbk_appointments_autolock_avail_limit',
			array ( $this, 'validate_appointments_autolock_avail_limit' )
		);
	    add_settings_field(
	    ...
	    register_setting(
	        'wbk_options',
	        'wbk_appointments_lock_timeslot_if_parital_booked',
	        array ( $this, 'validate_appointments_lock_timeslot_if_parital_booked' )
	    );
		add_settings_field(
	    ...
	    register_setting(
	        'wbk_options',
	        'wbk_appointments_continuous',
	        array ( $this, 'validate_appointments_continuous' )
	    );
		add_settings_field(
	    ...
	    register_setting(
	        'wbk_options',
	        'wbk_appointments_lock_day_if_timeslot_booked',
	        array ( $this, 'validate_appointments_lock_day_if_timeslot_booked' )
	    );
		add_settings_field(
		...
		register_setting(
		    'wbk_options',
		    'wbk_appointments_lock_one_before_and_one_after',
		    array ( $this, 'validate_appointments_lock_one_before_and_one_after' )
		);
    	register_setting(
        	'wbk_options',
        	'wbk_hide_from_on_booking',
		...
		register_setting(
			'wbk_options',
			'wbk_recurring_holidays',
			 array ( $this, 'validate_recurring_holidays' )
		);
    	...
    	register_setting(
        	'wbk_options',
        	'wbk_email_admin_cancel_multiple_mode',
         	 array ( $this, 'validate_email_admin_cancel_multiple_mode' )
    	);
		add_settings_field(
    	...
    	register_setting(
        	'wbk_options',
        	'wbk_email_customer_cancel_multiple_mode',
         	 array ( $this, 'validate_email_customer_cancel_multiple_mode' )
    	);
		add_settings_field(
		...
		register_setting(
			'wbk_options',
			'wbk_email_reminders_only_for_approved',
		 	 array ( $this, 'validate_email_reminders_only_for_approved' )
		);
    	add_settings_field(
	    ...
	    register_setting(
	        'wbk_options',
	        'wbk_email_current_invoice_number',
	         array ( $this, 'validate_email_current_invoice_number' )
	    );
		add_settings_field(
	    ...
	    register_setting(
	        'wbk_options',
	        'wbk_scroll_container',
	         array ( $this, 'validate_scroll_container' )
	    );
	    ...
	    register_setting(
	        'wbk_options',
	        'wbk_server_time_format',
	         array ( $this, 'validate_server_time_format' )
	    );
		add_settings_field(
	    ...
	    register_setting(
	        'wbk_options',
	        'wbk_server_time_format2',
	         array ( $this, 'validate_server_time_format2' )
	    );
 		add_settings_field(
		...
		register_setting(
			'wbk_options',
			'wbk_avaiability_popup_calendar',
			 array ( $this, 'validate_avaiability_popup_calendar' )
		);
    	add_settings_field(
	        'wbk_gdrp',
		...
		register_setting(
	    	'wbk_options',
	    	'wbk_allow_ongoing_time_slot',
	    	array ( $this, 'validate_allow_ongoing_time_slot' )
		);
		add_settings_field(
		...
		register_setting(
			'wbk_options',
			'wbk_days_in_extended_mode',
			array ( $this, 'validate_days_in_extended_mode' )
		);
        add_settings_field(
        ...
        register_setting(
            'wbk_options',
            'wbk_show_details_prev_booking',
             array ( $this, 'validate_show_details_prev_booking' )
        );
    	register_setting(
        	'wbk_options',
        	'wbk_nothing_to_pay_message',
		...
		add_settings_field(
			'wbk_day_label',
			__( 'Date label above the times lots', 'wbk' ),
		...
		add_settings_field(
			...
			__( 'Currency multiplier', 'wbk' ),
			array( $this, 'render_paypal_multiplier' ),
			'wbk-options',
			'wbk_paypal_settings_section',
			array()
		);
		register_setting(
			'wbk_options',
			'wbk_paypal_multiplier',
			 array ( $this, 'validate_paypal_multiplier' )
		);
    	...
    	add_settings_field(
	        'wbk_gg_2way_group',
	        __( 'Synchronization of group services:', 'wbk' ),
	        array( $this, 'render_gg_2way_group'),
	        'wbk-options',
	        'wbk_gg_calendar_settings_section',
	        array()
	    );
	    register_setting(
	        'wbk_options',
	        'wbk_gg_2way_group',
	        array ( $this, 'validate_gg_2way_group' )
	    );
        add_settings_field(
	        'wbk_gg_ignore_free',
	        __( 'Ignore free events:', 'wbk' ),
	        array( $this, 'render_gg_ignore_free'),
	        'wbk-options',
	        'wbk_gg_calendar_settings_section',
	        array()
	    );
	    register_setting(
	        'wbk_options',
	        'wbk_gg_ignore_free',
	        array ( $this, 'validate_gg_ignore_free' )
	    );
		add_settings_field(
	        'wbk_stripe_tax',
	        __( 'Tax', 'wbk' ),
		...
		add_settings_field(
	        ...
	        __( 'Additional payment information', 'wbk' ),
	        array( $this, 'render_stripe_additional_fields'),
	        'wbk-options',
	        'wbk_stripe_settings_section',
	        array()
	    );
	    register_setting(
	        'wbk_options',
	        'wbk_stripe_additional_fields',
	        array ( $this, 'validate_stripe_additional_fields' )
	    );
	    add_settings_field(
	        'wbk_stripe_redirect_url',
	        __( 'Redirect to page when payment is successful', 'wbk' ),
	        array( $this, 'render_stripe_redirect_url' ),
	        'wbk-options',
	        'wbk_stripe_settings_section',
	        array()
	    );
	    register_setting(
	        'wbk_options',
	        'wbk_stripe_redirect_url',
	         array ( $this, 'validate_stripe_redirect_url' )
	    );
		add_settings_field(
		   'wbk_stripe_mob_font_size',
		   __( 'Font size for card element on mobile devices', 'wbk' ),
		   array( $this, 'render_stripe_mob_font_size' ),
		   'wbk-options',
		   'wbk_stripe_settings_section',
		   array()
		);
		register_setting(
		   'wbk_options',
		   'wbk_stripe_mob_font_size',
		   array ( $this, 'validate_stripe_mob_font_size' )
      	);
		// ******************************************************************************************************
		...
		add_settings_field(
			...
			__( 'Automatically add to cart', 'wbk' ),
			array( $this, 'render_woo_auto_add_to_cart' ),
			'wbk-options',
			'wbk_woo_settings_section',
			array()
		);
		register_setting(
			'wbk_options',
			'wbk_woo_auto_add_to_cart',
			 array ( $this, 'validate_woo_auto_add_to_cart' )
		);
		// ******************************************************************************************************
		...
		register_setting(
			'wbk_options',
			'wbk_appointments_table_columns',
			array ( $this, 'validate_appointments_table_columns' )
		);
		add_settings_field(
		...
		register_setting(
			'wbk_options',
			'wbk_backend_select_services_onload',
			array ( $this, 'validate_backend_select_services_onload' )
		);
		add_settings_field(
	...
	public function enqueueScripts() {
 		if ( isset( $_GET[ 'page' ] ) && $_GET[ 'page' ] == 'wbk-options' ) {
	        ...
	        wp_enqueue_script( 'wbk-options', plugins_url( 'js/wbk-options.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-ui-dialog', 'jquery-ui-tabs' ), '3.3.77' );
	...
	public function render_days_in_extended_mode() {
		$value = get_option( 'wbk_days_in_extended_mode', 'disallow' );
		$value = sanitize_text_field( $value );
		$html = '<select id="wbk_days_in_extended_mode" name="wbk_days_in_extended_mode">
				    <option ' . selected(  $value, 'default', false ) . ' value="default">' . __( 'Default (3)', 'wbk' ).'</option>
	...
	public function validate_days_in_extended_mode( $input ) {
		$input = trim( $input );
		$input = sanitize_text_field( $input );
		if ( $input != 'default' && $input != 'lowlimit' && $input != 'uplimit' ){
			$input = 'default';
		}
 		return $input;
	}
