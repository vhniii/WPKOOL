	...
	public function enqueueScripts() {
		...
		if( $this->has_shortcode( 'webba_booking' ) || $this->has_shortcode( 'webba_email_landing' ) ||  $this->has_shortcode( 'webba_multi_service_booking' ) ) {
			...
			if( get_option( 'wbk_jquery_nc', 'disabled' ) == 'disabled' ){
			    wp_enqueue_script( 'wbk-frontend', plugins_url( 'js/wbk-frontend.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-effects-core' ), '3.4.3' );
			} elseif( get_option( 'wbk_jquery_nc', 'disabled' ) == 'enabled' ){
				wp_enqueue_script( 'wbk-frontend', plugins_url( 'js/wbk-frontend-nc.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-effects-core' ), '3.4.3' );
			}
			if( get_option( 'wbk_pickadate_load', 'yes' ) == 'yes' ){
			    wp_enqueue_script( 'picker', plugins_url( 'js/picker.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-effects-core' ), '3.4.3' );
			    wp_enqueue_script( 'picker-date', plugins_url( 'js/picker.date.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-effects-core' ), '3.4.3' );
			    wp_enqueue_script( 'picker-legacy', plugins_url( 'js/legacy.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-effects-core' ), '3.4.3' );
			}
			if( get_option( 'wbk_date_input', 'popup' ) == 'popup' ){
				wp_enqueue_style( 'picker-default', plugins_url( 'css/default.css', dirname( __FILE__ ) ), array(),  '3.4.3'  );
				wp_enqueue_style( 'picker-default-date', plugins_url( 'css/default.date.css', dirname( __FILE__ ) ), array(), '3.4.3' );
			} elseif( get_option( 'wbk_date_input', 'popup' ) == 'classic' ){
				wp_enqueue_style( 'picker-classic', plugins_url( 'css/classic.css', dirname( __FILE__ ) ), array(), '3.4.3' );
				wp_enqueue_style( 'picker-classic-date', plugins_url( 'css/classic.date.css', dirname( __FILE__ ) ), array(), '3.4.3' );
			}
