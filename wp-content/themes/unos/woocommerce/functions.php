 ...
 * @return int
 */
if ( !function_exists('unos_woo_loop_per_page') ) :
function unos_woo_loop_per_page( $value ) {
	return intval( hoot_get_mod( 'wooshop_products' ) );
}
endif;
add_filter( 'loop_shop_per_page', 'unos_woo_loop_per_page', 20 );
 ...
 * @return int
 */
if ( !function_exists('unos_woo_loop_columns') ) :
function unos_woo_loop_columns( $value ) {
	return intval( hoot_get_mod( 'wooshop_product_columns' ) );
}
endif;
add_filter( 'loop_shop_columns', 'unos_woo_loop_columns', 999 );
 ...
 * @return void
 */
if ( !function_exists('unos_woo_custom_loop_columns_css') ) :
function unos_woo_custom_loop_columns_css() {
...
add_action( 'wp_enqueue_scripts', 'unos_woo_custom_loop_columns_css', 99 );
 ...
 * @return void
 */
if ( !function_exists( 'unos_woo_set_queried_object' ) ) :
function unos_woo_set_queried_object( $q ){
	if ( $q->is_main_query() )
		$r = get_queried_object();
}
endif;
add_action( 'pre_get_posts', 'unos_woo_set_queried_object', 9 );
