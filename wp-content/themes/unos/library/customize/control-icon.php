	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'icon' :
				...
				<div class="hoot-customize-control-icon-picked hoot-flypanel-button" data-flypaneltype="icon"><i class="<?php echo esc_attr( $iconvalue ) ?>"></i><span><?php esc_attr_e( 'Select Icon', 'unos' ) ?></span></div>
				<div class="hoot-customize-control-icon-remove"><i class="fas fa-ban"></i><span><?php esc_attr_e( 'Remove Icon', 'unos' ) ?></span></div>
