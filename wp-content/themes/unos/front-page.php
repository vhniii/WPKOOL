			...
			foreach ( $sections as $key => $section ) :
				if ( empty( $section[ 'sortitem_hide' ] ) ):
					...
					elseif ( $key == 'content' )
						...
						$type = $key;
					$type = apply_filters( 'unos_frontpage_sections_switch', $type, $key, $sections );

					// Exit the loop except main content for a paged post list (blog)
					if ( $type != 'content-blog' && apply_filters( 'unos_paged_frontpage_hidemodules', is_paged() ) )
						continue;
					...
					if ( $custom_template ):
						...
						switch( $type ):
							...
							default:
								...
								do_action( 'unos_frontpage_sections', $type, $sections, $section_class, $context );
