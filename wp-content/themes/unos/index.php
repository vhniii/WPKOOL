...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'index' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'unos_main_start', 'index.php' );
			...
			if ( have_posts() ) :
				...
				// Template modification Hook
				do_action( 'unos_loop_start', 'index.php' );
				...
				// Template modification Hook
				do_action( 'unos_loop_end', 'index.php' );

				echo '</div>';

				// Template modification Hook
				do_action( 'unos_before_loop_nav', 'index.php' );
			...
			// Template modification Hook
			do_action( 'unos_main_end', 'index.php' );
			?>
